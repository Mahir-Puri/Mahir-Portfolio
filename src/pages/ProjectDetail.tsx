...
import RTPNDiagram from '../components/RTPNDiagram'
...
export default function ProjectDetail() {
  ...
  useDocumentMeta(
    project ? `${project.title} | MAHIRFLIX` : 'Project not found | MAHIRFLIX',
    project ? project.oneLiner : 'This project could not be found.'
  )
